			...
			<ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: "center" }}>
				...
				>
					...
					<Form.Field>
						...
						<Form.Input inputStyle={styles.input} name="nume" validate={validation.required} />
						<Form.Error name={"nume"} />
					</Form.Field>
					<Form.Field>
						<Form.Label>Prenume</Form.Label>
						<Form.Input inputStyle={styles.input} name="prenume" validate={validation.required} />
					...
					<Form.SubmitButton style={{ marginTop: 13 }} title="Actualizeaza contul" />
				</Form>
			</ScrollView>
		</SafeAreaView>
	);
