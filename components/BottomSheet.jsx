...
const BottomSheet = forwardRef(
	(
		...
		const backDropAnimation = useAnimatedStyle(() => {
			const opacity = interpolate(topAnimation.value, [collapsedOffset - 10, newActiveHeight], [0, 0.5], "clamp");
		...
		return (
			<>
				{collapseOnExternalInteraction ? (
					...
					>
						<Animated.View
							style={[styles.backDrop, backDropAnimation, { backgroundColor: backDropColor, display: "none" }]}
						/>
					</TouchableWithoutFeedback>
				) : (
					<></>
